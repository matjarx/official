...
const rival = RIVAL_DATA['wp-experts']

export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoOverride('comparisons/wp-experts')
  return {
    alternates: { canonical: '/alternatives/matjarx-vs-wp-experts' },
...
export default async function Page() {
  const content = await getMergedContent<ComparisonContentShape>('comparisons/wp-experts')
  return <ComparisonContent rivalKey="wp-experts" content={content} />
}
