...
export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoOverride('comparisons/global-dezigns')
  return {
...
export default async function Page() {
  const content = await getMergedContent<ComparisonContentShape>('comparisons/global-dezigns')
  return <ComparisonContent rivalKey="global-dezigns" content={content} />
}
