...
const rival = RIVAL_DATA['viftech']

export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoOverride('comparisons/viftech')
  return {
    alternates: { canonical: '/alternatives/matjarx-vs-viftech' },
...
export default async function Page() {
  const content = await getMergedContent<ComparisonContentShape>('comparisons/viftech')
  return <ComparisonContent rivalKey="viftech" content={content} />
}
