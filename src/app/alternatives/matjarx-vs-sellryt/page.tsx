...
export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoOverride('comparisons/sellryt')
  return {
...
export default async function Page() {
  const content = await getMergedContent<ComparisonContentShape>('comparisons/sellryt')
  return <ComparisonContent rivalKey="sellryt" content={content} />
}
