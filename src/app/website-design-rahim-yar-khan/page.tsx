...
export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoOverride('cities/rahim-yar-khan')
  return {
...
export default async function Page() {
  const content = await getMergedContent<LocationContentShape>('cities/rahim-yar-khan')
  return <LocationContent locationKey="rahim-yar-khan" content={content} />
}
