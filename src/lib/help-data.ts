...
export const HELP_TOPICS = [
  { slug: 'getting-started', title: 'Getting started', count: 9, icon: 'M12 3.5 5 7v10l7 3.5 7-3.5V7ZM12 12l7-4M12 12v8.5M12 12 5 8', body: 'What happens after you sign up, the questionnaire, the seven-day build and your launch call.' },
  { slug: 'billing-and-plans', title: 'Billing and plans', count: 11, icon: 'M4 6h16v12H4zM4 10h16M7 14h4', body: 'Invoices, switching plans, the setup fee, refunds and how to update your payment card.' },
  { slug: 'website-editor', title: 'Website editor', count: 14, icon: 'M4 20h16M6 16 18 4l3 3L9 19H6z', body: 'Changing images and text, adding sections, and switching functions like bookings or a store on.' },
  { slug: 'domains-and-email', title: 'Domains and email', count: 8, icon: 'M4 6h16v12H4zM4 7l8 6 8-6', body: 'Connecting a domain you own, DNS records, setting up mailboxes and fixing delivery problems.' },
  { slug: 'ecommerce-and-payments', title: 'E-commerce and payments', count: 12, icon: 'M4 6h2.2l2.3 9.5h9L20 8H7M9.5 20a1.2 1.2 0 1 0 0-2.4 1.2 1.2 0 0 0 0 2.4Z', body: 'Products and variants, JazzCash, Easypaisa and PayFast, cash on delivery, shipping rates and refunds.' },
  { slug: 'seo-and-marketing', title: 'SEO and marketing', count: 10, icon: 'M11 4.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM16 16l4.5 4.5', body: 'Google Business Profile, Maps, reviews, keyword reporting and connecting Analytics or Meta Pixel.' },
  { slug: 'account-and-security', title: 'Account and security', count: 7, icon: 'M12 3.5 4.5 6.5v5c0 4.4 3.1 7.6 7.5 9 4.4-1.4 7.5-4.6 7.5-9v-5Z', body: 'Passwords, changing your login email, exporting your data, backups and account deletion.' },
] as const
...
export const HELP_CHANNELS: Channel[] = [
  ...
  { title: 'Call us', value: '+92 303 372 0953', note: 'Monday to Friday, 11am to 8pm Pakistan time.',
...
export const HELP_CONTACT_ROWS = [
  { label: 'Address', value: '6c, Ln 4, Zamzama Boulevard, Clifton, Karachi.', note: '', icon: 'M12 21s7-5.5 7-11a7 7 0 1 0-14 0c0 5.5 7 11 7 11ZM12 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z' },
  { label: 'Hours', value: 'Monday – Friday, 11am to 8pm.', note: '', icon: 'M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17ZM12 8v4.5l3 2' },
